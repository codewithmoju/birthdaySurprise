...
export function createWishesMessage() {
  ...
  const messageHTML = `
    <div class="wishes-message">
      <h2>A Message From Your Brother, <span class="nickname-highlight">${randomTerm}</span></h2>
      <p>Today marks the beginning of an extraordinary chapter. May your <span class="highlight">22nd year</span> be filled with profound <span class="highlight">growth</span>, authentic <span class="highlight">connections</span>, and moments that take your breath away.</p>
      ...
      <p>As your brother, I'm so proud of the incredible woman you are. Here's to the adventures ahead, the lessons you'll embrace, and all the amazing things coming your way. Happy Birthday, <span class="nickname-highlight">${siblingTerms[Math.floor(Math.random() * siblingTerms.length)]}</span>!</p>
